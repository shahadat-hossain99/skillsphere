...
const InstructorCard = ({ instructor }) => {
  return (
    <div className="group relative bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition-all duration-500 hover:-translate-y-3 hover:shadow-[0_20px_60px_-15px_rgba(93,56,222,0.25)]">
      <Chip className="absolute top-3 left-3 z-20 bg-teal-400 text-black text-xs px-3 py-1 rounded-full shadow">
        {instructor.category}
      </Chip>
      ...
      <div className="p-6 relative z-10">
        <h3 className="text-lg font-semibold text-slate-900 group-hover:text-teal-400 transition">
          {instructor.name}
        </h3>
